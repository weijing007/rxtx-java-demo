...
public class RXTXSerialPortEventListener implements SerialPortEventListener {
	...
	public void serialEvent(SerialPortEvent serialPortEvent) {
		...
		/*
		 * SerialPortEvent.BI:/*Break interrupt,通讯中断 SerialPortEvent.OE:/*Overrun
		 * error，溢位错误 SerialPortEvent.FE:/*Framing error，传帧错误
		 * SerialPortEvent.PE:/*Parity error，校验错误 SerialPortEvent.CD:/*Carrier
		 * detect，载波检测 SerialPortEvent.CTS:/*Clear to send，清除发送
		 * SerialPortEvent.DSR:/*Data set ready，数据设备就绪 SerialPortEvent.RI:/*Ring
		 * indicator，响铃指示 SerialPortEvent.OUTPUT_BUFFER_EMPTY:/*Output buffer is
		 * empty，输出缓冲区清空
		 */
